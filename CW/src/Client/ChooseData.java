 ...
 * @author Anas
 */
public class ChooseData extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setText("Playlist Track");
  ...
  new PlaylistTrackDataView().setVisible(true);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChooseData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
